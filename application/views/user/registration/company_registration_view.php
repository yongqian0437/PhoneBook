                                ...
                                <?= form_open_multipart('') ?>    
                                        <div class="form-row pt-4 px-3">
                                            ...
                                            <div class="form-group col-md-12 px-2">
                                              <input type="text" class="form-control border-bottom" style="border: 0;" name="c_name" placeholder="Company Name" value="<?=set_value('c_name')?>" required>
                                        ...
                                        <div class="form-row pt-3 px-3">
                                            <!-- Company Address -->
                                            <div class="form-group col-md-12 px-2">
                                              <textarea class="form-control border-bottom" style="border: 0;" rows="3" name="c_address" placeholder="Company Address" required></textarea>
                                            </div>
                                        </div>
                                        <div class="form-row pt-3 px-3">
