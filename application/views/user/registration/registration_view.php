                            ...
                            <div class="card h-100" id='card2' ">
                                ...
                                <form>
                                    ...
                                    <div class="form-row pt-5 px-3">
                                        ...
                                        <div class="form-group col-md-6 px-2">
                                            <input type="type" name="user_lname" class="form-control border-bottom" id="user_lname" style="border: 0;" placeholder="Enter your last name" required>
                                        </div>
                                    </div>
                                    <!-- Email-->
                                    <div class="form-row pt-3 px-3">
                                        <div class="form-group col-md-12 px-2">
                                            <input type="email" name="user_email" class="form-control border-bottom" id="user_email" style="border: 0;" placeholder="Enter your email address" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row px-3">
                                        <div class="form-group col-md-12 px-2">
                                            <select name="user_role" id="user_role" class="form-control form-select border-bottom" style="border: 0;" required>
                                                ...
                                                <option value="EA">Education Agent</option>
                                                <option value="EP">Education Partner</option>
                                                <option value="AC">Academic Counselor</option>
                                            </select>
                                        </div>
                                    </div>
                                    <!-- Submit button -->
