					...
					<div class="form-content">
						...
						<div class="form-row">
							<div class="form-holder">
								<input type="text" name="e_phonenumber" placeholder="Phone Number" class="form-control" required>
							</div>
							<div class="form-holder">
								<input type="text" name="e_businessemail" placeholder="Business Email" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
			...
			<section>
				<div class="inner">
					...
					<div class="form-content">
						...
						<div class="form-row">
							<div class="form-holder">
								<input type="text" name="e_nationality" placeholder="Nationality" class="form-control">
							</div>
							<div class="form-holder">
								<input type="date" name="e_dob" placeholder="Date of Birth" class="form-control">
							</div>
						</div>
						<div class="form-holder" style="align-self: flex-end; transform: translateY(4px);">
							<div class="checkbox-tick">
								...
								<label class="female">
									<input type="radio" name="e_gender" value="female"> Female<br>
									<span class="checkmark"></span>
								</label>
							</div>
						</div>
			...
			<section>
				<div class="inner">
					...
					<div class="form-content">
						...
						<div class="form-row">
							<div class="form-holder">
								<input type="text" name="e_jobtitle" placeholder="Job Title" class="form-control">
							</div>
							<div class="form-holder">
								<input type="file" name="e_document" class="form-control">
							</div>
						</div>
