                            ...
                            <div class="card h-100" id='card2' >
                               ...
                               <?= form_open_multipart('') ?>
                                        ...
                                        <div class="form-row pt-3 px-3">
                                            <!-- Address -->
                                            <div class="form-group col-md-12 px-2">
                                               <textarea class="form-control border-bottom" style="border: 0;" rows="3" name="uni_address" placeholder="University Address" required></textarea>
                                            </div>
                                        </div>
                                        <div class="form-row pt-3 px-3">
                                            <!-- Hotline-->
                                        ...
                                        <div class="form-row pt-3 px-3">
                                            <!--  Website -->
                                            <div class="form-group col-md-12 px-2">
                                              <input type="text" class="form-control border-bottom" style="border: 0;" name="uni_website" placeholder="University Website" required>
                                            </div>
                                        </div>
                                        <div class="form-row pt-3 px-3">
