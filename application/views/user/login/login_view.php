                        ...
                        <div class="col-xl-5 ">
                            <div class="card h-100" id='card2' ">
                                ...
                                <form>
                                    ...
                                    <div class="form-row pt-5 px-3">
                                        <div class="form-group col-md-12 px-2">
                                            <input type="email" name="email" class="form-control border-bottom" id="email" style="border: 0;" placeholder="Enter your email address" required>
                                        </div>
                                    </div>
                                    <!-- Password and confirm password -->
                                    <div class="form-row pt-3 pb-3 px-3">
                                        <div class="form-group col-md-12 px-2">
                                            <input type="password" name="password" class="form-control border-bottom" id="password" style="border: 0;" placeholder="Enter your password" required>
                                        </div>
                                    </div>
                                    <!-- Submit button -->
                                    <div class="pt-1 pr-4">
                                ...
                                <!-- End of Input fields (Form) -->
                                    ...
                                    <a class="nav-link" style="text-align:center;" href="#!">Register an account</a>
                            </div>
                        </div>
                    </div>
                </div>
