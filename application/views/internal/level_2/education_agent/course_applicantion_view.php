<div class="container">
<a href="<?=base_url();?>internal/level_2/education_agent/course_applicantion/add_course_application" class="btn btn-primary">Add New Course Applicant Form</a>
</div>
...
<div id="content">    
    ...
    <div class="card shadow mb-4">
        ...
        <div class="table-responsive">
                <table class="table table-bordered" id="table_course_applicant" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>First Name</th>
