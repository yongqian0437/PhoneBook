...
<nav class="navbar sticky-top navbar-expand topbar" style="background-color: #6B9080;">
    ...
    <a class="navbar-brand py-0 ml-4 pl-3" href="#">
        <img src="<?php echo base_url('assets/img/LogoTesting2.png'); ?>" height="71" alt="">
    </a>
    <!-- </nav> -->
        ...
        <?php if ($this->session->has_userdata('user_id')) { ?>
            ...
            <li class="nav-item dropdown no-arrow pl-1" style="">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <img class="img-profile rounded-circle pl-1" src="img/undraw_profile.svg">
                </a>
                <!-- Dropdown - User Information -->
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" style="background-color: #6B9080;" aria-labelledby="userDropdown">
                    <a class="dropdown-item" href="#" style="color: white;">
